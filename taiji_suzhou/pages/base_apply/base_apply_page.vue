<template>
	<view class="base-apply">
		...
		<swiper :style="[heightStyle]" @change="changeSwiper" :autoplay="autoplay" :current="currentNav">
			...
			<swiper-item><material-page ref="material" :pageHeight="pageHeight" @pre="preStep" @tempStore="tempStore" @next="nextStep"></material-page></swiper-item>
			<swiper-item><mail-express-page ref="express" @pre="preStep" @tempStore="tempStore" @next="nextStep"></mail-express-page></swiper-item>
			<swiper-item><comfirm-page :pageHeight="pageHeight" @pre="preStep" @tempStore="tempStore" @apply="apply"></comfirm-page></swiper-item>
		</swiper>
	</view>
</template>
...
export default {
	...
	computed: mapState(['applyItemInfo', 'userInfo', 'businessModel', 'formsModel', 'materialsModel', 'postModel', 'uploadMaterials', 'uploadMaterialsNum', 'materialList']),
	onLoad(options) {
