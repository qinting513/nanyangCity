		...
		methods: {
			checkLogin(){
				...
				if (null != accessToken && undefined != accessToken && '' != accessToken) { 
					...
					// 否则先打开一个地址 来重定向
					window.location.href = "http://59.61.216.120:18891/oauth/authorize?client_id=d30778ad7ff04bf389e747cf5ceb3e6c&response_type=code&grant_type=authorization_code&scope=snsapi_base&redirect_uri=http://192.168.100.59"
				}
			}
		}
	}
