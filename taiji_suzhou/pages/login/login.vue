<template>
	<view class="container">
		...
		<view class="main-view">
			<image @click="back" class="backB-btn" src="../../static/images/home/icon_back_arrow.png" mode="aspectFill">
			</image>
			...
			<inputView @bindInputChange="getUserInput" img="../../static/images/login_register/icon_login_phone.png"
				placeholder="请输入账号" :initValue="user"></inputView>
			<inputView :password="true" @bindInputChange="getPwdInput"
				img="../../static/images/login_register/icon_login_pwd.png" placeholder="请输入密码" :initValue="pwd">
			</inputView>
			<view style="margin-top: 40upx;">
				<normalBtn @click="login" text="登 录"></normalBtn>
			</view>
