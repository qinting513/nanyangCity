...
function getMaterialList(permId) {
	return new Promise(function(resolve, reject) {
		...
		console.log("获取材料列表");
		WebApi.soup(Api.url_base_apply_get_materail, Api.method_base_apply_get_materail, params).then(res => {
			resolve(res);
		}).catch((err) => {
			reject(err);
		});
...
function getFormByPermidV2(permId) {
	return new Promise(function(resolve, reject) {
		...
		WebApi.soup(Api.url_base_apply_get_materail, Api.method_base_apply_get_getFormByPermidV2, params).then(res => {
			resolve(res);
		}).catch((err) => {
			reject(err);
		});
...
function getWebhallbusiness(token, bsnum) {
	return new Promise(function(resolve, reject) {
		...
		WebApi.soup(Api.url_submit_apply, Api.method_base_apply_getwebhallbusiness, params).then(res => {
			resolve(res);
		}).catch((err) => {
			reject(err);
		});
...
function getInsFormData(token, bsnum) {
	return new Promise(function(resolve, reject) {
		...
		WebApi.soup(Api.url_submit_apply, Api.method_base_apply_getInsFormData, params).then(res => {
...
function getInsMaterialInfo(token, bsnum) {
	return new Promise(function(resolve, reject) {
		...
		WebApi.soup(Api.url_submit_apply, Api.method_base_apply_getInsMaterialInfo, params).then(res => {
			if (res["code"] == 200 && res["ReturnValue"] != null) {
				let returnValue = res["ReturnValue"];
...
function getPermWsfwsd(permId) {
	...
	return new Promise(function(resolve, reject) {
		...
		WebApi.soup(Api.url_permname_list, Api.mothod_getPermWsfwsd, params).then(res => {
			resolve(res);
		}).catch((err) => {
			reject(err);
		});
...
function getNetworkByPermid(permId) {
	return new Promise(function(resolve, reject) {
		...
		WebApi.soup(Api.url_organization, Api.mothod_getNetworkByPermid, params).then(res => {
			resolve(res);
		}).catch((err) => {
			reject(err);
		});
...
function getRegionByPermidBsnum(permId, bsnum) {
	return new Promise(function(resolve, reject) {
		...
		WebApi.soup(Api.url_department, Api.mothod_getRegionByPermidBsnum, params).then(res => {
			resolve(res);
		}).catch((err) => {
			reject(err);
		});
...
function getUserPostInfo(userId) {
	return new Promise(function(resolve, reject) {
		...
		WebApi.soup(Api.url_reset_address_service_query, Api.mothod_getUserPostInfo, params).then(res => {
			resolve(res);
		}).catch((err) => {
			reject(err);
		});
...
function tempStore(params) {
	return new Promise(function(resolve, reject) {
		...
		WebApi.soup(Api.url_submit_apply, Api.method_submit_apply, params).then(res => {
			resolve(res);
		}).catch((err) => {
			reject(err);
		});
